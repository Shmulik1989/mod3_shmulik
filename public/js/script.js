function DataHandler() {
  ...
  $("#lowerNav ul li, #fifaRulesNav, #logout, #loginPage, #continue"
  ).on("click", function() {
  ...
  //Limit access to chat for registerd users only.
  ...
  //Call the function that limit access to chat for registerd users only
  that.chatNav();
}
